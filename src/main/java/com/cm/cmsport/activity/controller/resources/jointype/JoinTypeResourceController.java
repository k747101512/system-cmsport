package com.cm.cmsport.activity.controller.resources.jointype;
...
/**
 * @ClassName: JoinTypeResourceController
 * @Description: 活动参加方式
 * @Author: WenG
 * @Date: 2020-08-12 15:10
 * @Version: 1.0
 **/
@Api(tags = ISystemConstant.API_TAGS_RESOURCE_PREFIX + "活动参加方式接口")
@RestController
@RequestMapping(ISystemConstant.RESOURCE_PREFIX + "/jointype")
public class JoinTypeResourceController extends AbstractController {
